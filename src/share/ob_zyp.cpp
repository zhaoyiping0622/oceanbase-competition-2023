...
// }
// 
// void zyp_broadcast_sys_table_schemas_bootstrap(obrpc::ObSrvRpcProxy* rpc_proxy, ObDDLService* ddl_service, ObArray<ObTableSchema> &table_schemas) {
// 	//OB_ZYP_TIME_COUNT;
//   int ret = OB_SUCCESS;
...
void zyp_create_table_async(obrpc::ObSrvRpcProxy* rpc_proxy, ObDDLService* ddl_service, const int64_t tenant_id) {
//    zyp_real_sleep(10);
...
//      zyp_broadcast_sys_table_schemas_bootstrap(rpc_proxy, ddl_service, tables);
//    } else {
